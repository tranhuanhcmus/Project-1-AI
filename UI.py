...
class HomePage:
    ...
    def draw(self,WIN):
        ...
        self.Start=Button(40,self.h/5+100,'START','Image/bt.jpg')
        self.Exit=Button(40,self.h/5*2+100,'EXIT','Image/bt.jpg')
        self.INS=Button(40,self.h/5*3+100,'Instruction','Image/bt.jpg')
